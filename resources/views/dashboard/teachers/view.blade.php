      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
            ...
            @can('Add Teacher')
              <div class="col-md-6">
                <a href="{{ url('teacher/add') }}" type="button" class="btn btn-primary" style="float:right;">Add Teacher</a>
              </div>
            @endcan
          </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                      @can('Edit Teacher')
                        <a title="Edit" href="{{ url('teacher/edit/'.encrypt($teacher->id)) }}">
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <a href="{{ url('teacher/destroy/'.encrypt($teacher->id)) }}" type="button" class="btn btn-primary">Yes</a>
                              </div>
                            </div>
                          </div>
                        </div>
